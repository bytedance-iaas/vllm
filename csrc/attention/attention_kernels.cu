...
__device__ void paged_attention_kernel(
    ...
    const int blocksparse_head_sliding_step, const std::string& sparse_cache_type,
...
void paged_attention_v1(
    ...
    const int64_t blocksparse_head_sliding_step, const std::string& sparse_cache_type,
    torch::Tensor& attention_scores) {
