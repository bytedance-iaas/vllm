...
def paged_attention_v1(
    ...
    torch.ops._C.paged_attention_v1(
        ...
        blocksparse_block_size, blocksparse_head_sliding_step, sparse_cache_type, attention_scores)
...
def sparse_cache_copy(key_caches: torch.Tensor, value_caches: torch.Tensor,
    ...
    torch.ops._C_cache_ops.sparse_cache_copy(key_caches, value_caches, block_mapping_src, block_mapping_dst, selection_index_src_tensor, selection_index_dst_tensor, num_heads, head_size, block_size)
