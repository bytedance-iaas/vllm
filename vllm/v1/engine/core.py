...
class EngineCore:
    ...
    def step(self) -> EngineCoreOutputs:
        ...
        if len(scheduler_output.d2h_swap_map) > 0:
            logger.info(f"xxxxxxxx swap out happen.")

        if len(scheduler_output.h2d_swap_map) > 0:
            logger.info(f"xxxxxxxx swap in happen.")
