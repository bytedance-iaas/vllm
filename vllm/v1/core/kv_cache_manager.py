    ...
    def allocate_slots(
        ...
        Args:
            ...
            reserved_blocks: Number of free blocks that must be left available for
                ...
                made if it fits within (free blocks - reserved_blocks). For the
                full-sequence admission check this only applies when
                full_sequence_num_tokens is provided.
        ...
        if full_sequence_must_fit:
            ...
            if full_sequence_num_tokens is not None:
