...
class Scheduler:
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        scheduler_output = SchedulerOutput(
            ...
            d2h_swap_map=copy.deepcopy(self.kv_cache_manager.block_pool.step_d2h_swap_map),
            h2d_swap_map=copy.deepcopy(self.kv_cache_manager.block_pool.step_h2d_swap_map),
        )
