...
class LLMEngine:
    ...
    def step(self) -> List[Union[RequestOutput, PoolingRequestOutput]]:
        ...
        if not scheduler_outputs.is_empty():
            ...
            try:
                outputs, remote_prefill_result = self.model_executor.execute_model(
        ...
        for req_id, notif_count in remote_prefill_result.request_notif_counter.items():
        ...
        for req_id, done_count in remote_prefill_result.request_done_counter.items():
