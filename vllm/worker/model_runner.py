...
class ModelRunner:
            ...
            for seq_id in seq_ids:
                ...
                for i in range(context_len, seq_len):
                    ...
                    if self.cache_config.sparse_cache_type == "h2o" and n_times >= 0:
                        ...
                        seq_lens.pop()
                        temp_lens.append(kv_cache_pos % self.block_size + 1 + (len(block_table) - 1) * self.block_size) # Update seq_lens item
    ...
    def execute_model(
        ...
        if self.cache_config.sparse_cache_type != 'auto' and sparse_condition is not None:
            condition = sparse_condition[0]
            sparse_type = (self.cache_config.sparse_cache_type, self.cache_config.sparse_interval, self.cache_config.sparse_percentage)
