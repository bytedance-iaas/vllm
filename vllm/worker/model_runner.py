...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    class InterDataForSeqGroup:
        ...
        def __init__(
            ...
            *,
            ...
            block_global_computed_only: List[Dict[int, List[int]]],
            ...
            self.block_global_computed_only = {}   
    ...
    def transfer_global_computed_blocks(self, attn_metadata: AttentionMetadata):
        ...
        offsets = []
        for inter_data in self.inter_data_list:
            for seq_id, block_ids in inter_data.block_global_computed_only.items():
                for block_id in block_ids:
                    block_hash = attn_metadata.block_hash_map[seq_id][block_id]
                    k_offset = block_id * block_size
