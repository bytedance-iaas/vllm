...
def _validate_asymmetric_region_lengths(
    ...
    tp_ratio = (
        1 if producer_cache_replicated else _get_tp_ratio(local_tp_size, remote_tp_size)
    )
...
class MooncakeConnectorWorker:
    ...
    def _logical_to_kernel_block_ids(
        ...
        physical_block_ids = []
        for group, cache_group in zip(block_ids, self.kv_cache_config.kv_cache_groups):
