...
# from vllm.model_executor import libentry
# from vllm.model_executor import set_random_seed
# import vllm.model_executor.libentry as libentry
# import numpy as np
...
class UnquantizedLinearMethod(LinearMethodBase):
    ...
    def apply(self,
              ...
              x: torch.Tensor,
              bias: Optional[torch.Tensor] = None) -> torch.Tensor:
        # transposed = np.transpose(layer.weight)
        ...
        # opt bias is not None
        # llama bias is None
        if bias is None:
            return mm(x, transposed)
        else:
            return addmm(bias, x, transposed)
