...
@pytest.mark.parametrize(
    ...
    [(4, torch.bfloat16), (128, torch.float32)],
)
...
def test_c128_bf16_state_dtype_fails_before_kernel_dispatch():
    config = SimpleNamespace(
        attention_config=SimpleNamespace(
    ...
    with pytest.raises(ValueError, match="C128 BF16 compressor implementation"):
        _get_compression_state_dtype(config, 128)
