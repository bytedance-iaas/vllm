...
def test_extend_queries_keeps_cpu_sequence_shadows() -> None:
    metadata = _metadata(
    ...
    assert extended._seq_lens_cpu is metadata._seq_lens_cpu
    assert extended.seq_lens_cpu_upper_bound is metadata.seq_lens_cpu_upper_bound
    assert extended.dcp_local_seq_lens_cpu is metadata.dcp_local_seq_lens_cpu
